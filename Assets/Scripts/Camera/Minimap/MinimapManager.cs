...
namespace Minimap
{
    ...
    public class MinimapManager : MonoBehaviour {
        ...
        [SerializeField]
        GameObject _redDoorSprite;
        [SerializeField]
        GameObject _blueDoorSprite;
        [SerializeField]
        GameObject _greenDoorSprite;
        ...
        void GetFakeRooms(Vector2 currentRoomPos, Node addToNode)
        {
            ...
            for (int i = 0; i < doors.Length; ++i)
            {
                ...
                if (!hasRoom)
                {
                    ...
                    switch (doors[i].type)
                    {
                        case Door.Type.Default:
                            sprite = _doorSprite;
                            break;
                        case Door.Type.Red:
                            sprite = _redDoorSprite;
                            break;
                        case Door.Type.Green:
                            sprite = _greenDoorSprite;
                            break;
                        case Door.Type.Blue:
                            sprite = _blueDoorSprite;
                            break;
                        default:
                            sprite = _doorSprite;
                            break;
                    }
                    addToNode.AddPossibleNeighboor(new Vec2Int((int)deltaPosition.x, (int)deltaPosition.y), sprite, _doorSize);
                }
            }
        }
