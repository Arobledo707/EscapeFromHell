...
public class Inventory : MonoBehaviour {
    ...
    public void RemoveWeapon(int index)
    {
        ...
        m_weaponList[index].transform.parent = Room.current.transform;
    ...
    {
        m_consumableList[index].transform.parent = Room.current.transform;
   ...
   public void DestroyConsumable(int index)
    {
        ...
        //Set the current consumables to an existing consumable in inventory
        for (int i=0; i<m_consumableList.Length; ++i)
        {
            if (m_consumableList[i] != null)
            {
